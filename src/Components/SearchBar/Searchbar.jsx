...
const handleTimeframeChange = (e) => {
  ...
  className="px-4 py-2 rounded-xl border border-gray-300 w-full sm:w-auto bg-amber-200 text-gray-800 shadow-md focus:outline-none focus:ring-2 focus:ring-amber-400 transition-all duration-200 cursor-pointer"
>
